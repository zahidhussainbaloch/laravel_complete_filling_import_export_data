...
<body>
    ...
    <form class="form-right" action="add_form_data" method="POST">
    	@csrf
    	
        <h2 class="text-uppercase">Registration form</h2>
        <div class="row">
            <div class="col-sm-6 mb-3"> <label>Full Name</label> <input type="text" name="name" id="first_name" class="input-field"> 
            </div>

		</div>

        <div class="mb-3">
         <label>Your Email</label> <input type="email" class="input-field" name="email" required> 
        </div>

        <div class="row">
            <div class="col-sm-6 mb-3"> <label>Password</label> <input type="password" name="pwd" id="pwd" class="input-field"> 
            </div>

        </div>

        <div class="col-sm-6 mb-3"> <label>Mobile</label> <input type="text" name="phone_number" id="mobile" class="input-field"> 
        </div>
        ...
        <div class="col-sm-6 mb-3">
         ...
         <div class="col-sm-6 mb-3">
        		 ...
        		 <input type="text" name="address" id="city" class="input-field">
